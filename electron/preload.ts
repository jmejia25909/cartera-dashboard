...
contextBridge.exposeInMainWorld("carteraApi", {
  ...
  campanasGuardar: (data: any) => ipcRenderer.invoke("campanasGuardar", data),
  ...
  disputaCrear: (data: any) => ipcRenderer.invoke("disputaCrear", data),
  cuentasAplicarListar: () => ipcRenderer.invoke("cuentasAplicarListar"),
  cuentaAplicarCrear: (data: any) => ipcRenderer.invoke("cuentaAplicarCrear", data),
  cuentaAplicarActualizar: (data: any) => ipcRenderer.invoke("cuentaAplicarActualizar", data),
});
